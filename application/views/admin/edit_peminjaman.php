                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <?php echo form_open('admin/update_peminjaman'); ?>
                            ...
                            <div class="form-group">
                                ...
                                echo form_dropdown('id_customer', $options, $transaksi->id_customer, array('class' => 'form-control', 'id' => 'id_customer'));
                                ?>
                            ...
                            <div class="form-group">
                                ...
                                echo form_dropdown('id_alat', $options, $transaksi->id_alat, array('class' => 'form-control', 'id' => 'id_alat'));
                                ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input('tanggal_sewa', $transaksi->tanggal_sewa, array('class' => 'form-control', 'id' => 'tanggal_sewa', 'type' => 'date')); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input('tanggal_kembali', $transaksi->tanggal_kembali, array('class' => 'form-control', 'id' => 'tanggal_kembali', 'type' => 'date')); ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php echo form_input('total_bayar', $transaksi->total_bayar, array('class' => 'form-control', 'id' => 'total_bayar', 'placeholder' => 'Masukkan total bayar')); ?>
                                <?php echo form_error('total_bayar', '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="status">Status</label>
                                <?php echo form_dropdown('status', array('proses' => 'Proses', 'selesai' => 'Selesai', 'batal' => 'Batal'), $transaksi->status, array('class' => 'form-control', 'id' => 'status')); ?>
                            </div>
                            <div class="form-group">
